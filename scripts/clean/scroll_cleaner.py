"""Cleaner for Scroll.in Magazine listing page."""
...
_BASE = "https://scroll.in"

# Scroll articles live under /article/ or /latest/ etc.
# But since we are on the magazine category page, most links will be articles.
...
class ScrollCleaner(BaseCleaner):
    """Parses Scroll.in Magazine listing page into Article stubs."""

    source_name = "scroll_magazine"
